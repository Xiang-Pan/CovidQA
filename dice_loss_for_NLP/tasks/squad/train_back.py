...
class BertForQA(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log('avg_loss', avg_loss, on_step=False, sync_dist=True)
        self.log('span_f1', span_f1, on_step=False, sync_dist=True)
        self.log('exact_match', exact_match, on_step=False, sync_dist=True)
