...
# from transformers import BertModel, BertPreTrainedModel, roberta
from transformers import RobertaModel
from models.classifier import truncated_normal_
# from models.model_config import BertForSequenceClassificationConfig #roberta
...
class RobertaForSequenceClassification(RobertaPreTrainedModel):
    ...
    def __init__(self, config: RobertaForSequenceClassificationConfig,roberta_share = None):
