...
MODEL_CKPT=$REPO_PATH/cached_models/roberta_covidqa_2epoch.ckpt

HPARAMS_PATH=${REPO_PATH}/outputs/roberta-base/covidqa/lightning_logs/covidqa_covidqa/hparams.yaml
